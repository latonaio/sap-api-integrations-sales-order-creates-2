...
import "sap-api-integrations-sales-order-creates/SAP_API_Caller/responses"
...
type Header struct {
    ...
    ToHeaderPartner                responses.HeaderPartner `json:"to_Partner"`
    ToItem                         responses.Item `json:"to_Item"`	
}
...
type Item struct {
	...
	ToItemPricingElement        responses.ItemPricingElement `json:"to_PricingElement"`
	ToItemScheduleLine          responses.ItemScheduleLine `json:"to_ScheduleLine"`
}
